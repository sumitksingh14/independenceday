...
var ContactComponent = class _ContactComponent {
  ...
  onSubmit() {
    if (this.contactForm.valid) {
      ...
      setTimeout(() => {
        ...
        alert("Thank you for your message. Happy Independence Day!");
      }, 1e3);
    }
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactComponent, selectors: [["app-contact"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 31, vars: 12, consts: [[1, "page-container", "fade-in"], [1, "page-header", "text-center"], [1, "heading-primary", "text-gradient"], [1, "subtitle"], [1, "contact-container", "container"], [1, "glass-card", "contact-form-wrapper"], [1, "contact-form", 3, "ngSubmit", "formGroup"], [1, "form-group"], ["for", "name"], ["type", "text", "id", "name", "formControlName", "name", "placeholder", "Your Name", 3, "ngClass"], ["for", "email"], ["type", "email", "id", "email", "formControlName", "email", "placeholder", "Your Email", 3, "ngClass"], ["for", "message"], ["id", "message", "rows", "5", "formControlName", "message", "placeholder", "Your Message", 3, "ngClass"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [1, "map-placeholder", "glass-card"], [1, "map-overlay"], [1, "fa-solid", "fa-location-dot"], ["src", "https://images.unsplash.com/photo-1524492412937-b28074a5d7da?q=80&w=2070&auto=format&fit=crop", "alt", "Map Placeholder", 1, "map-img"]], template: function ContactComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(22);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(23, "div", 15)(24, "div", 16)(25, "h3");
      \u0275\u0275element(26, "i", 17);
      \u0275\u0275text(27, " New Delhi, India");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(28, "p");
      \u0275\u0275text(29, "15 August Marg, Independence Square");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(30, "img", 18);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(6, _c0, ((tmp_1_0 = ctx.contactForm.get("name")) == null ? null : tmp_1_0.invalid) && ((tmp_1_0 = ctx.contactForm.get("name")) == null ? null : tmp_1_0.touched)));
      \u0275\u0275advance(4);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(8, _c0, ((tmp_2_0 = ctx.contactForm.get("email")) == null ? null : tmp_2_0.invalid) && ((tmp_2_0 = ctx.contactForm.get("email")) == null ? null : tmp_2_0.touched)));
      \u0275\u0275advance(4);
      \u0275\u0275property("ngClass", \u0275\u0275pureFunction1(10, _c0, ((tmp_3_0 = ctx.contactForm.get("message")) == null ? null : tmp_3_0.invalid) && ((tmp_3_0 = ctx.contactForm.get("message")) == null ? null : tmp_3_0.touched)));
      \u0275\u0275advance();
      \u0275\u0275property("disabled", ctx.contactForm.invalid || ctx.isSubmitted);
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", ctx.isSubmitted ? "Sending..." : "Send Message", " ");
    }
  }, dependencies: [CommonModule, NgClass, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName], styles: ["\n\n.page-container[_ngcontent-%COMP%] {\n  padding: 100px 20px 60px;\n  min-height: 100vh;\n}\n.page-header[_ngcontent-%COMP%] {\n  margin-bottom: 50px;\n}\n.page-header[_ngcontent-%COMP%]   h1[_ngcontent-%COMP%] {\n  font-size: 3rem;\n  margin-bottom: 10px;\n}\n.page-header[_ngcontent-%COMP%]   .subtitle[_ngcontent-%COMP%] {\n  font-size: 1.2rem;\n  color: #555;\n}\n.container[_ngcontent-%COMP%] {\n  max-width: 1000px;\n  margin: 0 auto;\n}\n.contact-container[_ngcontent-%COMP%] {\n  display: grid;\n  grid-template-columns: 1fr 1fr;\n  gap: 40px;\n}\n.contact-form-wrapper[_ngcontent-%COMP%] {\n  padding: 40px;\n}\n.contact-form[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 20px;\n}\n.form-group[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 8px;\n}\n.form-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  font-weight: 600;\n  color: var(--color-navy);\n}\n.form-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%], \n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%] {\n  padding: 12px 15px;\n  border: 1px solid rgba(0, 0, 0, 0.1);\n  border-radius: 8px;\n  font-size: 1rem;\n  font-family: var(--font-primary);\n  transition: all 0.3s ease;\n}\n.form-group[_ngcontent-%COMP%]   input[_ngcontent-%COMP%]:focus, \n.form-group[_ngcontent-%COMP%]   textarea[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: var(--color-saffron);\n  box-shadow: 0 0 0 2px rgba(255, 153, 51, 0.2);\n}\n.form-group[_ngcontent-%COMP%]   input.error[_ngcontent-%COMP%], \n.form-group[_ngcontent-%COMP%]   textarea.error[_ngcontent-%COMP%] {\n  border-color: #e74c3c;\n}\n.btn[_ngcontent-%COMP%] {\n  padding: 15px 30px;\n  background: var(--color-green);\n  color: white;\n  border: none;\n  border-radius: 30px;\n  font-size: 1.1rem;\n  font-weight: 600;\n  cursor: pointer;\n  transition: all 0.3s ease;\n  margin-top: 10px;\n}\n.btn[_ngcontent-%COMP%]:hover:not(:disabled) {\n  background: #0f6c06;\n  transform: translateY(-2px);\n}\n.btn[_ngcontent-%COMP%]:disabled {\n  opacity: 0.7;\n  cursor: not-allowed;\n}\n.map-placeholder[_ngcontent-%COMP%] {\n  position: relative;\n  overflow: hidden;\n  border-radius: 16px;\n}\n.map-placeholder[_ngcontent-%COMP%]   .map-img[_ngcontent-%COMP%] {\n  width: 100%;\n  height: 100%;\n  object-fit: cover;\n  filter: grayscale(0.5);\n}\n.map-placeholder[_ngcontent-%COMP%]   .map-overlay[_ngcontent-%COMP%] {\n  position: absolute;\n  bottom: 0;\n  left: 0;\n  right: 0;\n  padding: 30px;\n  background:\n    linear-gradient(\n      to top,\n      rgba(0, 0, 0, 0.8),\n      transparent);\n  color: white;\n}\n.map-placeholder[_ngcontent-%COMP%]   .map-overlay[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  margin: 0 0 10px 0;\n  color: var(--color-saffron);\n  display: flex;\n  align-items: center;\n  gap: 10px;\n}\n.map-placeholder[_ngcontent-%COMP%]   .map-overlay[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  margin: 0;\n}\n@media (max-width: 768px) {\n  .contact-container[_ngcontent-%COMP%] {\n    grid-template-columns: 1fr;\n  }\n  .map-placeholder[_ngcontent-%COMP%] {\n    height: 300px;\n  }\n}\n/*# sourceMappingURL=contact.component.css.map */"] });
};
(() => {
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-FBOOVL5I.js.map
