...
var AbsorbersInstancesManager = class {
  ...
  addAbsorber(container, options, position) {
    return __async(this, null, function* () {
      const {
        AbsorberInstance
      } = yield import("./chunk-M3T2VQSP.js"), absorber = new AbsorberInstance(this.#pluginManager, container, options, position), array = this.getArray(container);
      array.push(absorber);
      return absorber;
    });
  }
...
//# sourceMappingURL=chunk-OSOPLBE4.js.map
