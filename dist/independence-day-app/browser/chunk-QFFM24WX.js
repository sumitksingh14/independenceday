...
var Engine = class {
  ...
  load(params) {
    return __async(this, null, function* () {
      ...
      const {
        Container
      } = yield import("./chunk-GRYAPLPO.js"), id = params.id ?? domSourceElement?.id ?? `tsparticles${Math.floor(getRandom() * loadRandomFactor).toString()}`, {
        index,
        url
...
//# sourceMappingURL=chunk-QFFM24WX.js.map
