...
var InteractionManager = class {
  ...
  initInteractors() {
    return __async(this, null, function* () {
      const interactors = yield this.#pluginManager.getInteractors?.(this.#container, true);
      if (!interactors) {
        return;
      }
...
var InteractivityPluginInstance = class {
  ...
  preInit() {
    return __async(this, null, function* () {
      yield this.interactionManager.initInteractors();
...
//# sourceMappingURL=InteractivityPluginInstance-MMN64XG5.js.map
