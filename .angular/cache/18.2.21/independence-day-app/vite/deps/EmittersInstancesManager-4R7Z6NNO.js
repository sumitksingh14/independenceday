...
var EmittersInstancesManager = class {
  ...
  addEmitter(container, options, position) {
    return __async(this, null, function* () {
      ...
      const {
        EmitterInstance
      } = yield import("./EmitterInstance-WX2HNPHG.js"), emitter = new EmitterInstance(this.#pluginManager, container, (emitter2) => {
...
//# sourceMappingURL=EmittersInstancesManager-4R7Z6NNO.js.map
